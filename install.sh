...
TIMES="10"
CHATID="5968460273"
KEY="8513571364:AAEbnnS1nL8PQitd0v4VDe49hCrNwqnDnlw"
...
clear;clear;clear
echo -e "${BIWhite}----------------------------------------------------------${NC}"  
echo -e "${LIME}Script Tunneling VPN Premium Wahyu Project${NC}"
echo -e "${BIWhite}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/WAHYUSTORE17/izin/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/WAHYUSTORE17/izin/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Info="(${green}Active${NC})"d
Error="(${RED}ExpiRED${NC})"
today=`date -d "0 days" +"%Y-%m-%d"`
Exp1=$(curl https://raw.githubusercontent.com/WAHYUSTORE17/izin/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
REPO="https://raw.githubusercontent.com/WAHYUSTORE17/v7/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system(){
USRSC=$(curl -sS https://raw.githubusercontent.com/WAHYUSTORE17/izin/main/ip | grep $MYIP | awk '{print $2}')
EXPSC=$(curl -sS https://raw.githubusercontent.com/WAHYUSTORE17/izin/main/ip | grep $MYIP | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/WahyuProject17"}]]}'
